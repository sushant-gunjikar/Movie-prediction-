  ...
  ======================================================= -->
   ...
   /* function readURL(input)
	...
	function callme()
	{
		...
		window.location="upd_awriter.php?b="+a;
		...
		<div class="col-xs-12">
		  ...
		  <div class="panel panel-warning">
			...
			<div class="panel-body">
				<form action="ins_upd_awriter.php" name="myForm" method="post" enctype="multipart/form-data">
					<div class="col-md-4"></div>
						...
						<?php
							...
							if(isset($_GET['b']))
							{
								$qry = "select * from writer where id = '".$_GET['b']."'";
