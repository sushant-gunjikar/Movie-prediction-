<?php
	...
	$sql = "INSERT INTO director(pics,id,name,movies,hit_movies,flop_movies,rating) VALUES ('".$pathAndName."', '$_POST[id]', '$_POST[name]', '$_POST[movies]', '$_POST[hits]', '$_POST[flops]', '$_POST[rating]')";
	...
	else
	{
		...
		echo "<script>window.location = 'adirector.php';</script>";
	}
	mysqli_close($con);
?>