  ...
  ======================================================= -->
   <script>
	...
	function callme()
	{
		...
		window.location="upd_amus_dir.php?b="+a;
		...
		<div class="col-xs-12">
		  ...
		  <div class="panel panel-warning">
			...
			<div class="panel-heading">
			  <h3>Update Music Director</h3>
			</div>
			
			<div class="panel-body">
				<form action="u_amus_dir.php" name="myForm" method="post" enctype="multipart/form-data">
					<div class="col-md-4"></div>
						...
						<?php
							...
							if(isset($_GET['b']))
							{
								$qry = "select * from music_director where id = '".$_GET['b']."'";
