  ...
  ======================================================= -->
   <script>
	...
	function callme()
	{
		...
		window.location="upd_aactor.php?b="+a;
		...
		<div class="col-xs-12">
		  ...
		  <div class="panel panel-warning">
			...
			<div class="panel-body">
				<form action="ins_upd_aactor.php" name="myForm" method="post" enctype="multipart/form-data">
					<div class="col-md-4"></div>
						...
						<?php
							...
							if(isset($_GET['b']))
							{
								$qry = "select * from actor where id = '".$_GET['b']."'";
