    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
		  ...
		  <li class="active"><a href="awriter.php">Writer</a></li>
		...
		<div class="col-xs-12">
		  ...
		  <div class="panel panel-warning">
			...
			<div class="panel-body">
			  ...
			  <form action="ins_awriter.php" name="myForm" method="post" enctype="multipart/form-data">
					<div>
					...
					<div class="row">
						<div align="center">
							...
							<a href="upd_awriter.php" class="btn btn-info btn-flat" role="button">Update</a>
							<a href="view_awriter.php" class="btn btn-info btn-flat" role="button">View</a>
						</div>
					</div>
				</form>
