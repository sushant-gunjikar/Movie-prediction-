<?php
	...
	$sql = "update music_director set name='".$_POST['name']."', movies='".$_POST['movies']."', hit_movies='".$_POST['hits']."', flop_movies='".$_POST['flops']."', rating='".$_POST['rating']."' where id='".$_POST['id']."'";
	...
	else
	{
		...
		echo "<script>window.location = 'upd_amus_dir.php';</script>";
	}
	mysqli_close($con);
?>
