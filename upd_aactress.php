...
<head>
  ...
  <title>MSP upd_aactress.php</title>
  ...
  ======================================================= -->
   ...
   /* function readURL(input)
	...
	function callme()
	{
		...
		window.location="upd_aactress.php?b="+a;
		...
		<div class="col-xs-12">
		  ...
		  <div class="panel panel-warning">
			...
			<div class="panel-heading">
			  <h3>Update Actress</h3>
			</div>
			
			<div class="panel-body">
				<form action="ins_upd_aactress.php" name="myForm" method="post" enctype="multipart/form-data">
					<div class="col-md-4"></div>
						...
						<?php
							...
							if(isset($_GET['b']))
							{
								$qry = "select * from actress where id = '".$_GET['b']."'";
