    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
		  ...
		  <li class="active"><a href="amus_dir.php">Music Director</a></li>
		...
		<div class="col-xs-12">
		  ...
		  <div class="panel panel-warning">
			...
			<div class="panel-heading">
			  <h3>Music_Director</h3>
			</div>
			
			<div class="panel-body">
			 
			  <form action="ins_amus_dir.php" name="myForm" method="post" enctype="multipart/form-data">
					<div>
					...
					<div>
						<b>3.</b>No.of Movies:
							<input type="number" name="movies" class="form-control" id="movies" required onkeyup="calc()"/>
							<br/>
					</div>
					
					<div>
						<b>4.</b>No.of hits:
							<input type="number" name="hits" class="form-control" id="hits" required onkeyup="calc()"/>
							<br/>
					</div>
					
					<div>
						<b>5.</b>No.of flops:
							<input type="number" name="flops" class="form-control" id="flops" required onkeyup="calc()"/>
							<br/>
					</div>
					
					<div>
						<b>6.</b>Rating:
							<input type="number" name="rating" required id="rating" class="form-control" onkeyup="calc()"/>
							<br/>
					</div>
					...
					<div class="row">
						<div align="center">
							...
							<a href="upd_amus_dir.php" class="btn btn-info btn-flat" role="button">Update</a>
							<a href="view_amus_dir.php" class="btn btn-info btn-flat" role="button">View</a>
						</div>
					</div>
				</form>
